...
def test_tc_fe_clients_036(client_page):
    ...
    page.fill_edit_select_modal(  "Industry", ClientFormData.VALID_INDUSTRY)
    ...
    start_time = time.perf_counter()
    page.fill_edit_select_modal(  "Country", ClientFormData.VALID_COUNTRY)
