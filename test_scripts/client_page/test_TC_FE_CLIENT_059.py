...
def test_tc_fe_clients_059(client_page):
    """
    ...
    prev_btn = page.find_element(PaginationLocators.PREV_PAGE_BTN)
    ...
    next_btn = page.find_element(PaginationLocators.NEXT_PAGE_BTN)
